...
public class SelectionEquipeController implements Observer {
    ...
    private void initialize() {
        ...
        confirmButton.setOnAction(event -> {
            System.out.println("Left team is : " + (leftTeam.getChildren().size() - redTeam.getChildren().size() - blueTeam.getChildren().size()));
            if (leftTeam.getChildren().size() - redTeam.getChildren().size() - blueTeam.getChildren().size()== 0 && redTeam.getChildren().size() >= 2
